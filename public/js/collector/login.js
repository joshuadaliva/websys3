...
<div class="form-eyebrow">Collector Portal</div>
<div class="form-title">Welcome back</div>
<div class="form-sub">Sign in to your collector account to continue.</div>
...
<input class="fc has-icon" id="inp-email" type="text" placeholder="collector@lgu.gov.ph" value="collector" autocomplete="username" onkeydown="if(event.key==='Enter')document.getElementById('inp-pw').focus()"/>
</div>
</div>
...
<input class="fc has-icon has-right" id="inp-pw" type="password" placeholder="Enter your password" value="collector123" autocomplete="current-password" onkeydown="if(event.key==='Enter')doLogin()"/>
...
function doLogin() {
  ...
  setTimeout(() => {
    // Demo: accept collector/collector123 or any non-empty
    if ((email === "collector" || email.includes("@")) && pw.length >= 6) {
      renderLogin({
        type: "suc",
